...
{
	public static boolean isGLdestroyed=false;
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		glSurfaceView =(BoardwalkGLSurfaceView) findViewById(R.id.main_gl_surface);
		glSurfaceView.setOnTouchListener(new View.OnTouchListener() {
			public boolean onTouch(View v, MotionEvent e) {
				//Toast.makeText(MainActivity.this,"touchGLing",Toast.LENGTH_LONG).show();
		...
		glSurfaceView.setRenderer(new GLSurfaceView.Renderer() {
			...
			public void onSurfaceChanged(GL10 gl, int width, int height) {
				//Toast.makeText(context,"GLSurfaceChanged",Toast.LENGTH_LONG).show();
			}
		});
	...
	public boolean onTouch(View v, MotionEvent e) {
		boolean isDown;
		//Toast.makeText(this,"touching",Toast.LENGTH_LONG).show();
		switch (e.getActionMasked()) {
			case MotionEvent.ACTION_DOWN:
			case MotionEvent.ACTION_POINTER_DOWN:
				isDown = true;
	...
	private static String[] buildMCArgs(Context context, String versionName, MinecraftVersion version) {
		...
		boolean demo = false;
		String username = prefs.getString("auth_lastEmail", "Player");
		...
		//retval.add("-XMX"+LauncherActivity.getRAM().toString());
